...
//     td.setAttribute("id", `cell-${rowNum}-${i}`);
//
//     // Agar bu birinchi ustun (0-indeksli ustun) bo'lsa
//     if (i === 0) {
//       td.setAttribute("class", "row-header");
...
//
//       // Bu inputlarni qaysi ustunga qo'yishimiz kerakligini aniqlaymiz
//       input.setAttribute("id", `input-${rowNum}-${i}`);
//
...
//   const tableBodyElement = document.getElementById("table-body2");
//
